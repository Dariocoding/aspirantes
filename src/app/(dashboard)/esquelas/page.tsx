...
import { createBirthdayEsquela, createEfemerideEsquela } from "@/app/actions/esquelas";
...
import { CalificacionAdmision, type Prisma, type TipoEsquela } from "@/generated/prisma";
        ...
        <CardContent className="space-y-2 p-3 sm:p-4">
          {esquelas.length === 0 ? (
            <div className="flex flex-col items-center gap-2 rounded-xl border border-dashed border-slate-200 bg-slate-50/50 py-12 text-center">
              ...
              <p className="font-medium text-slate-800">Aún no hay esquelas generadas</p>
