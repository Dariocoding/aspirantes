    ...
    <div className="space-y-5">
      ...
      <AspirantePerfilView
        a={{
          ...
          madreFechaNacimientoLabel: a.madreFechaNacimiento
            ? a.madreFechaNacimiento.toLocaleDateString("es-VE")
            : null,
          padreNombres: a.padreNombres,
          padreApellidos: a.padreApellidos,
          padreCedula: a.padreCedula,
          padreFechaNacimientoLabel: a.padreFechaNacimiento
            ? a.padreFechaNacimiento.toLocaleDateString("es-VE")
            : null,
