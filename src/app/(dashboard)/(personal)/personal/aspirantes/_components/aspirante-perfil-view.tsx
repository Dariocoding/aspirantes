              ...
              <div key={def.id} className="rounded-lg border border-slate-200 bg-white p-3 shadow-sm">
                ...
                <dl className="mt-3 space-y-2 border-t border-slate-100 pt-3 text-sm">
                  ...
                  <div className="flex justify-between gap-3">
                    ...
                    <dd className="min-w-0 text-right text-xs tabular-nums text-slate-900">{f.subtotal.trim() || "â€”"}</dd>
                  </div>
              ...
              {PRUEBA_FISICA_FILAS.map((def) => {
                ...
                return (
                  <TableRow key={def.id}>
                    ...
                    <TableCell className="text-center text-xs tabular-nums">{f.datosM.trim() || "â€”"}</TableCell>
                    <TableCell className="text-center text-xs tabular-nums">{f.datosF.trim() || "â€”"}</TableCell>
                    <TableCell className="text-center text-xs">{f.calificacion.trim() || "â€”"}</TableCell>
                    <TableCell className="text-center text-xs tabular-nums">{f.porcentaje.trim() || "â€”"}</TableCell>
                    <TableCell className="text-center text-xs tabular-nums">{f.subtotal.trim() || "â€”"}</TableCell>
        ...
        <CardContent className="space-y-6 p-4 sm:p-6">
          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              />
              <Campo label="Estatura (m)" value={formatEstaturaM(a.estaturaCm)} />
