...
import { deleteEfemeride } from "@src/app/actions/efemerides";
import {
  EfemerideCreateDialog,
  EfemerideEditDialog,
  EfemerideEditTriggerButton,
  type EfemerideRow,
} from "@dashboard/efemerides/_components/efemeride-modals";
import { Button } from "@src/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@src/components/ui/card";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@src/components/ui/table";
import { labelEfemerideTipo } from "@src/lib/efemeride-tipo";
import { MESES_LOWER } from "@src/lib/meses";
import { cn } from "@src/lib/utils";
import type { Efemeride } from "@src/generated/prisma";
...
export function EfemeridesView({ efemerides, canWrite: write }: Props) {
      ...
      <Card className="gap-0 py-0 shadow-sm shadow-slate-900/5 ring-slate-200/80">
        <CardHeader className="border-b border-slate-200/80 bg-linear-to-br from-slate-50 to-white px-4 py-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <EfemerideCreateDialog canWrite={write} />
          </div>
        </CardHeader>
      </Card>
