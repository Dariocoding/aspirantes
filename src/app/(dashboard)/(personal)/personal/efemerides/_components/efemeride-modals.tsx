...
import { createEfemeride, updateEfemeride } from "@src/app/actions/efemerides";
...
import { EFEMERIDE_TIPO_OPCIONES, normalizeEfemerideTipo } from "@src/lib/efemeride-tipo";
import { MESES_TITULO } from "@src/lib/meses";
import type { EfemerideActionState } from "@src/lib/action-types";
import { efemerideInitialActionState } from "@src/lib/action-types";
...
export function EfemerideCreateDialog({ canWrite: write }: { canWrite: boolean }) {
