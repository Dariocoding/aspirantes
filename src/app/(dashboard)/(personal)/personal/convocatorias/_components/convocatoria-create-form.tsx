...
import { createConvocatoria } from "@src/app/actions/convocatorias";
import {
  ...
  return (
    <>
      <SuccessCelebrationDialog
        ...
        description="El período quedó registrado. Puede activar la recepción desde el listado si año no lo hizo."
      />
